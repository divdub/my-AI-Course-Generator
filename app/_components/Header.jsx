...
const Header = () => {
  return (
    ...
    <div className="flex justify-between p-5 shadow-sm items-center bg-slate-800">
      <div className="flex items-center gap-2">
      <Link  href={'/'}  className="flex justify-center items-center gap-2">
      <Image src={'/logo.png'} width={44} height={44} alt="logo" /> <span className="font-bold text-xl">AI Course Generator</span>
      </Link>
      </div>
